  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-start">
        ...
        <motion.div
          className="bg-card rounded-3xl shadow-card p-8 order-2"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.05 }}
        >
          <h2 className="text-2xl font-display font-extrabold mb-2">Aprender brincando</h2>
          <p className="text-sm text-muted-foreground font-bold mb-6">Para crianças em alfabetização e também crianças com TEA (autismo). Atividades curtas, visuais, previsíveis e gamificadas.</p>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-extrabold">Conteúdo</p>
                <p className="text-sm text-muted-foreground font-bold">Matemática, Português e Inglês com lições interativas e gamificadas.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-extrabold">Motivação</p>
                <p className="text-sm text-muted-foreground font-bold">Pontos e progresso para engajar.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-xl bg-muted flex items-center justify-center text-lavender shrink-0">
                <Brain className="w-5 h-5" />
              </div>
              <div>
                <p className="font-extrabold">Rotina</p>
                <p className="text-sm text-muted-foreground font-bold">Lições curtas com feedback imediato.</p>
              </div>
            </div>
          </div>
